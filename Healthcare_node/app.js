  ...
  try {
    stockSchema
      ...
      .then((data) => {
        ...
        res
          .status(200)
          .json({ message: "Stock Enter Successfully", data: data });
      })
      .catch((error) => {
        console.log(error);
...
app.delete("/deleteitem/:Id", async (req, res) => {
  try {
    ...
    console.log(id);
    const stockData = await stockSchema
      .findByIdAndUpdate({ _id: id }, { enable: 0 })
      .then((data) => {
...
mongoose.connect(
  "mongodb+srv://barber:MvkGb3yXWuN79gnZ@barbercluster.hyxbhtr.mongodb.net/barber"
);
